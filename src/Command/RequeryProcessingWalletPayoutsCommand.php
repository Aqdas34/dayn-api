...
#[AsCommand(
    name: 'app:requery-processing-wallet-payouts',
    description: 'Add a short description for your command',
)]
class RequeryProcessingWalletPayoutsCommand extends Command
{
...
//        }
        ...
        $io->success('All processing payouts have been re-queried successfully!');
